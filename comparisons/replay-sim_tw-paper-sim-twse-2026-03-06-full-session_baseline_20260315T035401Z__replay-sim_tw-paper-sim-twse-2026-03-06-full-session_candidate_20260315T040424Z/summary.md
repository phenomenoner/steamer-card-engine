...
- status: **PASS**
- baseline run: `replay-sim_tw-paper-sim-twse-2026-03-06-full-session_baseline_20260315T035401Z` (baseline-bot)
- candidate run: `replay-sim_tw-paper-sim-twse-2026-03-06-full-session_candidate_20260315T040424Z` (steamer-card-engine)
